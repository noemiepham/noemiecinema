...
const AllFilms = () => {
  ...
  return (
    <div className="allFilms">
                        ...
                        {item.menu.map((element, i) => (
                          <Dropdown.Item
                            ...
                            onClick={() => {
                              switch (item.text) {
                                case "Language":
                                  setSelected.languages(element.name);
                                  break;
                                case "Lists":
                                  setSelected.list(element.name);
                                  break;
                                case "All genres":
                                  setSelected.genres(element.name);
                                  break;
                                default:
                                  setSelected.rating(element.name);
                              }
                            }}
                          >
                            {element.name}
      ...
      <Container>
        <CardFilms data={data.results} Sgenres={Sgenres} numItemShow={20} />
      </Container>
