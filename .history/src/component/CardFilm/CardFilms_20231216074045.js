...
//const image = "https://flixgo.volkovdesign.com/main/img/covers/16.png";
//const title = "Game of Troll";

function CardFilms({ data, genres }) {
    ...
    data.map((item) => (
      ...
      >
        ...
        <div className="card-body">
          <h1 className="titleFilms"> {item.title}</h1>
          <span>
          ...
          <span cardRate>⭐️ {item.vote_average}</span>
        </div>
      </div>
    ))
  );
